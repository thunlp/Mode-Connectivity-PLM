...
METRICS = {
    ...
    'glue-mnli': 'ACC',
    'glue-mnli_anli_mix5000': 'ACC',
    'glue-mnli_anli_mix10000': 'ACC',
    'glue-mnli_anli_mix15000': 'ACC',
    'glue-mnli_anli_allforget5000': 'ACC',
    'glue-mnli_anli_allforget10000': 'ACC',
    'glue-mnli_anli_allforget15000': 'ACC',
    'glue-mnli_anli_forgeteasy5000': 'ACC',
    'glue-mnli_anli_forgeteasy10000': 'ACC',
    'glue-mnli_anli_forgethard5000': 'ACC',
    'glue-mnli_anli_forgethard10000': 'ACC',
    'glue-mnli_anli_easy5000': 'ACC',
    'glue-mnli_anli_hard5000': 'ACC',
    'glue-mnli_anli_easy10000': 'ACC',
    'glue-mnli_anli_hard10000': 'ACC',
    'glue-mnli_anli_easy5000_new': 'ACC',
    'glue-mnli_anli_hard5000_new': 'ACC',
    'glue-mnli_anli_mix5000_new': 'ACC',
    'glue-mrpc': 'ACC',
    'glue-qnli': 'ACC',
    'glue-qqp': 'ACC',
    'glue-rte': 'ACC',
    ...
    'tab_fact_new': 'Classification-F1',
...
def evaluate(logger, predictions, data, metric, cartography):
    ...
    if metric == "EM":
        ...
        # currently cartography supports dataset with ACC as metrics
        if cartography:
            return_dict["cartography_acc"] = accs
    elif metric == "QA-F1":
        f1s = []
        for (prediction, dp) in zip(predictions, data):
